...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="<%=Constantes.getAppUrl() %>">
        <img src="${pageContext.request.contextPath}/resources/img/logoChronosFundoPreto.png" width="100" height="30" class="d-inline-block align-top" alt="Logo do módulo Chronos">
        <!--Chronos-->
    </a>  
