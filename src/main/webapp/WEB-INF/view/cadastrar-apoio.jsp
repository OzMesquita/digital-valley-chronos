                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <c:if test="${not empty pai}">
	                        ...
	                        <li class="breadcrumb-item active" aria-current="page">Cadastrar apoio</li>
                         </c:if>
                    </ol>
                </nav>
                ...
                <div class="form-group">
                    <form method="post" action="cadastrarApoio" accept-charset="UTF-8" enctype="multipart/form-data" id="needs-validation" novalidate enctype="multipart/form-data">
                       ...
                       <label for="dataPagamento">Data de Pagamento</label>
                        ...
                        <input type="button"  class="btn btn-primary" value="Salvar e Continuar" data-toggle="modal" data-target="#confirmarApoio" >
                        
                        <!-- Modal -->
                        <div class="modal fade" id="confirmarApoio" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalLabel">Confirmar cadastro do apoio</h5>
