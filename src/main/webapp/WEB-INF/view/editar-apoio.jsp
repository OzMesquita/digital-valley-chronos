					...
					href="/Chronos/atividades/${atividade.codAtividade}">${atividade.nome}</a></li>
						<li class="breadcrumb-item active" aria-current="page"><a
							href="/Chronos/EditarAtividade/${atividade.codAtividade}">Editar
								Atividade</a></li>
						<li class="breadcrumb-item" aria-current="page"><a
							href="/Chronos/apoiadores/${atividade.codAtividade}">Editar
								Apoiadores</a></li>		
						<c:if test="${empty pai}">
					...
					<form method="POST" action="/Chronos/editarApoio/${atividade.codAtividade}&${apoio.codApoio}" accept-charset="UTF-8"
						...
						<div id="sandbox-container">
							<div class="input-daterange input-group col-lg-3 align-left"
								...
								<input  value="${apoio.dataPagamento}"
									type="date" class="form-control text-left"
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<p>Você deseja confirmar a edição?</p>
									</div>
